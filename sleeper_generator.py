...
def generate_sleeper_sweep(sleeper_length: float, sleeper_profile_points: list):
    sleeper_step_file = "sleeper_sweep.step"
    ...
    gmsh.write(sleeper_step_file)
    gmsh.finalize()

    return sleeper_step_file
